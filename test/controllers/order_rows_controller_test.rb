...
class OrderRowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_row" do
    assert_difference("OrderRow.count") do
      post order_rows_url, params: { order_row: { order_id: @order_row.order_id, product_id: @order_row.product_id, quantity: @order_row.quantity } }
    end
  ...
  test "should update order_row" do
    patch order_row_url(@order_row), params: { order_row: { order_id: @order_row.order_id, product_id: @order_row.product_id, quantity: @order_row.quantity } }
