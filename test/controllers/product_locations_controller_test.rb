...
class ProductLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_location" do
    assert_difference("ProductLocation.count") do
      post product_locations_url, params: { product_location: { product_id: @product_location.product_id, quanity: @product_location.quanity, warehouse_id: @product_location.warehouse_id } }
    end
  ...
  test "should update product_location" do
    patch product_location_url(@product_location), params: { product_location: { product_id: @product_location.product_id, quanity: @product_location.quanity, warehouse_id: @product_location.warehouse_id } }
